...
def get_player_stats():
    ...
    playerquery = session.query(player_stats.id, player_stats.Player,player_stats.Age,player_stats.Team,
    ...
    for player in playerquery:
        ...
        player_dict['Age']=player[2]
        player_dict['Team']=player[3]
        player_dict['Position']=player[4]
        player_dict['Played']=player[5]
        player_dict['Minutes']=player[6]
        player_dict['Points_pg']=player[7]
        player_dict['2p%']=round(player[8],3)
        player_dict['3p%']=round(player[9],3)
        player_dict['Effective%']=round(player[10],3)
        player_dict['Free%']=round(player[11],3)
        player_dict['Rebounds']=player[12]
        player_dict['Assists']=player[13]
        player_dict['Steals']=player[14]
        player_dict['Blocks']=player[15]
        player_dict['Turnovers']=player[16]
        player_dict['Fouls']=player[17]
