...
def get_team_stats():
    ...
    gamesquery = session2.query(games.game_id, games.game_date, games.arena, games.arena_lat, games.arena_lon, games.attendance,
                              ...
                              games.fgm_home, games.fg2m_home, games.fg3m_home, games.fga_home, games.fg_pct_home, games.ftm_home, games.fta_home, games.ft_pct_home, games.stl_home, games.blk_home, games.pts_home,
                              games.fgm_away, games.fg2m_away, games.fg3m_away, games.fga_away, games.fg_pct_away, games.ftm_away, games.fta_away, games.ft_pct_away, games.stl_away,games.blk_away, games.pts_away).all()
    ...
    for game in gamesquery:
        ...
        game_dict['stl_home']=game[23]
        game_dict['blk_home']=game[24]
        game_dict['pts_home']=game[25]
        game_dict['fgm_away']=game[26]
        game_dict['fg2m_away']=game[27]
        game_dict['fg3m_away']=game[28]
        game_dict['fga_away']=game[29]
        game_dict['fg_pct_away']=game[30]
        game_dict['ftm_away']=game[31]
        game_dict['fta_away']=game[32]
        game_dict['ft_pct_away']=game[33]
        game_dict['stl_away']=game[34]
        game_dict['blk_away']=game[35]
        game_dict['pts_away']=game[36]
